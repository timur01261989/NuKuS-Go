  ...
  return (
    <Card style={{ borderRadius: 18, border: "1px solid #e2e8f0" }} bodyStyle={{ padding: 14 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 12 }}>
        <div>
          <div style={{ fontSize: 12, color: "#64748b", fontWeight: 700, marginBottom: 6 }}>{am("autoExtra.brand")}</div>
          <Select
            value={ad.brand || undefined}
            placeholder={am("autoExtra.select")}
        ...
        <div>
          <div style={{ fontSize: 12, color: "#64748b", fontWeight: 700, marginBottom: 6 }}>{am("autoExtra.model")}</div>
          <Select
            value={ad.model || undefined}
            placeholder={ad.brand ? am("create.chooseModel") : am("autoExtra.chooseBrandFirst")}
      ...
      <div style={{ marginTop: 12, fontSize: 12, color: "#64748b" }}>{am("autoExtra.tipCorrectName")}</div>
    </Card>
  );
}
