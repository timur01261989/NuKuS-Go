  ...
  const demos = useMemo(
    () => [
      ...
      },
      {
        ...
        load: () => import("../features/driver/components/DriverOrderFeed.jsx"),
      },
      {
        key: "DriverServiceSelect",
        kind: "component",
        title: "DriverServiceSelect",
        load: () => import("../features/driver/components/DriverServiceSelect.jsx"),
      },
      {
        key: "DriverVerification",
        kind: "component",
        title: "DriverVerification",
        load: () => import("../features/driver/components/DriverVerification.jsx"),
      },
      {
        key: "MapView",
        kind: "component",
      ...
      { key: "useDriverRadarSearch", kind: "module", title: "useDriverRadarSearch", load: () => import("../features/driver/hooks/useDriverRadarSearch.js") },
      { key: "driverSearchService", kind: "module", title: "driverSearchService", load: () => import("../features/driver/components/services/driverSearchService.js") },
      { key: "orderService", kind: "module", title: "orderService", load: () => import("../features/driver/components/services/orderService.js") },
      { key: "driverData", kind: "module", title: "driverData (mock)", load: () => import("../features/driver/components/driverData.js") },
