...
// ClientOrderCreate.jsx ichida:
import { PaymentStatus } from './PaymentStatus';

// ... status o'zgarganda (handleStatusChange ichida):
if (status === 'completed') {
    setMode('payment_success'); // Yangi rejim
    playSound('success'); // APK ichidagi professional MP3 ovozi
}
...
// ... return qismida, mode tekshirilayotgan joyda:
...
// ... return qismida, mode === 'main' bo'lgan joyda:
{mode === 'main' && (
