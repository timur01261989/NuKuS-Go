...
import { 
  ...
  EnvironmentOutlined, WalletOutlined, ToolOutlined, SearchOutlined
  ...
  return (
      <div style={{ padding: "20px", background: "#f8f9fa", minHeight: "100vh", fontFamily: 'YangoHeadline, sans-serif' }}>
        ...
        <div style={{ marginTop: 18 }}>
          <Card style={{ borderRadius: 24, border: 'none', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
            <Title level={5} style={{ marginTop: 0 }}>Super Pro</Title>
            <Row gutter={[12, 12]}>
              {appConfig.features.garage && (
                <Col span={8}>
                  <Button block icon={<ToolOutlined />} onClick={() => navigate('/garage')} {...btnTouchProps}>
                    Garage
                  </Button>
                </Col>
              )}
              {appConfig.features.payments && (
                <Col span={8}>
                  <Button block icon={<WalletOutlined />} onClick={() => navigate('/payments')} {...btnTouchProps}>
                    To‘lov
                  </Button>
                </Col>
              )}
              {appConfig.features.searchOnRoute && (
                <Col span={8}>
                  <Button block icon={<SearchOutlined />} onClick={() => navigate('/search-route')} {...btnTouchProps}>
                    Yo‘lda
                  </Button>
                </Col>
              )}
