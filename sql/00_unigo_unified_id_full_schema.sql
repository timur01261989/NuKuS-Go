...
-- SOURCE: sql/42_phase16_driver_bonus.sql
...
-- =========================
comment on table public.client_bonuses is 'DEPRECATED: use wallets.bonus_balance_uzs + wallet_transactions';
comment on table public.bonus_transactions is 'DEPRECATED: use wallet_transactions';
comment on table public.driver_bonus_ledger is 'DEPRECATED: use wallet_transactions for monetary rewards';
comment on table public.driver_bonus is 'DEPRECATED: use wallet_transactions for monetary rewards';
