/**
 * AuthForm.jsx — Login forma komponenti (pure presentational)
 * Auth.jsx dan ajratildi.
 * Barcha handler-lar prop orqali keladi — test qilish oson.
 */
import React, { memo } from 'react';

function AuthForm({
  phone, password, remember, showPassword, loading,
  t,
  onPhoneChange, onPasswordChange,
  onTogglePassword, onRememberChange,
  onSubmit, onNavigateRegister, onNavigateReset,
}) {
  return (
    <section className="rounded-3xl p-8 shadow-modern bg-white/90 backdrop-blur border border-white/20">
      <h2 className="text-xl font-semibold text-gray-800 mb-6 text-center">{t?.loginTitle || 'Kirish'}</h2>
