...
import { Alert, Button, Card, Col, ConfigProvider, Divider, Form, Row, Space, Steps, Typography } from "antd";
...
export const driverRegisterStyles = {
  ...
  shellStyles: { maxWidth: 1180, margin: "0 auto" },
  cardStyles: {
    borderRadius: 28,
    overflow: "hidden",
...
export const driverRegisterTheme = {
  token: {
    colorPrimary: "#06b6d4",
    colorText: "#e2e8f0",
  ...
  components: {
    Card: { colorBgContainer: "rgba(15, 23, 42, 0.92)" },
    Input: {
    ...
    Steps: { colorTextDescription: "#94a3b8", colorText: "#cbd5e1", colorPrimary: "#22d3ee" },
    Alert: { borderRadiusLG: 16 },
  },
};

export function buildHeaderExtra(applicationStatus, rejectionReason, adminNote) {
...
export function DriverRegisterLayout({
  initialLoading,
  current,
  form,
  files,
  ...
  const { pageStyles, shellStyles, cardStyles, heroStyles, contentStyles, stepPanelStyles } = driverRegisterStyles;
  return (
          ...
          <Card loading={initialLoading} bordered={false} style={cardStyles} styles={{ body: { padding: 0 } }}>
            <div style={heroStyles}>
              <Space direction="vertical" size={8} style={{ width: "100%" }}>
                ...
                <Paragraph style={{ color: "rgba(255,255,255,0.80)", margin: 0, maxWidth: 760 }}>
            ...
            <div style={contentStyles}>
              <div style={stepPanelStyles}>
                ...
                <Form form={form} layout="vertical" initialValues={initialFormState} requiredMark={false} scrollToFirstError preserve>
              ...
              <Row justify="space-between" align="middle" gutter={[12, 12]}>
                ...
                <Col>
                  {current < 2 ? (
                    <Button type="primary" size="large" onClick={goNext}>Keyingi</Button>
                  ) : (
                    <Button type="primary" size="large" icon={<CheckCircleOutlined />} loading={submitting} onClick={handleSubmit}>
                      Arizani yuborish
                    </Button>
                  )}
                </Col>
